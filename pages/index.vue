  ...
  <div class="col px-0 pb-5">
    <div class="banner p-0 position-relative d-flex align-items-center p-0 w-100 overflow-hidden border-bottom">
      ...
      <div id="info" class="position-absolute">
        <NuxtLink :to="`/${popular[0].attributes.slug}`">
          <h2 class="mb-1 text-white d-inline">{{ popular[0].attributes.canonicalTitle }}</h2>
        </NuxtLink>
        ...
        <PrimeButton v-if="popular[0].attributes?.youtubeVideoId" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#verModal">
