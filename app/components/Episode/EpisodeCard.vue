...
<template>
  <div class="h-100">
    <NuxtLink v-ripple class="episode-card bg-secondary d-block rounded h-100 text-white overflow-hidden" :to="data.url" target="_blank" data-aos="fade-in">
      <div class="bg-dark position-relative rounded-bottom-0 overflow-hidden">
        ...
        <span class="position-absolute top-50 start-50 translate-middle mb-0 invisible pe-none text-white"><Icon name="lucide:external-link" /></span>
      </div>
